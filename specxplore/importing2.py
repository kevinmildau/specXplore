...
def harmonize_and_clean_spectrum(spectrum : matchms.Spectrum):
    ...
    """
    minimum_number_of_required_peaks_per_spectrum = 1
    ...
    reduce_to_intensity_range = partial(matchms.filtering.select_by_relative_intensity, intensity_from=0.1, intensity_to=1)
